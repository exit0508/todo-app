                    ...
                    <div class="ui grid">
                        <div class="seven column row">
                            <div class="left floated four wide column">
                                <h2 class="ui header">サブタスク登録</h2>
                            </div>
                            <div class="right floated right aligned three wide column">
                                <button v-on:click="closeForm" class="ui labeled icon blue button">
...
export default {
    ...
    methods: {
        addClick: function(){
                this.$emit('subtodo-form', this.inputTodo, this.inputInterest, this.inputPleasant, this.inputComplexity, this.inputImportance)
                this.inputTodo = '',
